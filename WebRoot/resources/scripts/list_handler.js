              ...
              if(data.errorCode=="0000"){
                  ...
                  for(var z=0;z<fileList.length;z++){
                      ...
                      if(fileList[z].visiable==1) {
	                      	 if(fileList[z].title==$(obj).siblings('a').html()){
	                      		 $("iframe[name='detail'").attr("src","file_read.action?url="+fileList[z].url);
	                      	 }else if(!oParent.turn){
	                      		var Li = document.createElement('li');
	                      		 if(fileList[z].type=="mp4"||fileList[z].type=="webm"
	                      			 ||fileList[z].type=="wmv"||fileList[z].type=="ogg"
	                      				 ||fileList[z].type=="rmvb"||fileList[z].type=="avi"){
		                            Li.innerHTML = "<a href='view/video.jsp?url=" + fileList[z].url
